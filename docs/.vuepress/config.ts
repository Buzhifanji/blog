...
export default defineConfig4CustomTheme<VdoingThemeConfig>({
  ...
  themeConfig: {
    ...
    nav: [
      { text: "首页", link: "/" },
      {
        ...
        items: [
          ...
          //   text: "Javascript",
          //   link: "/web/",
          //   // items: [{ text: "JavaScript", link: "/web/" }],
          // },
        ],
      },
      {
    ...
    repo: "Buzhifanji/blog", // 导航栏右侧生成Github链接
    ...
    author: {
      name: "buzhifanji", // 必需
      link: "https://github.com/Buzhifanji", // 可选的
    },
    ...
    footer: {
      ...
      copyrightInfo:
        'buzhifanji | <a href="https://github.com/Buzhifanji/blog/master/LICENSE" target="_blank">MIT License</a>', // 博客版权信息，支持a标签或换行标签</br>
    },
