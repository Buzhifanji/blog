...
import { Fn, MaybeRef, Awaitable, ConfigurableEventFilter, ConfigurableFlush, RemovableRef, EventHookOn, IntervalFnOptions, Pausable } from '@vueuse/shared';
...
declare type SerializerAsync<T> = {
