import{_ as n,X as s,Y as a,a1 as t}from"./framework-7f72c1b4.js";const p={},e=t(`<p>执行顺序：先进后出（FILO）</p><div class="language-javascript line-numbers-mode" data-ext="js"><pre class="language-javascript"><code><span class="token keyword">class</span> <span class="token class-name">Stack</span> <span class="token punctuation">{</span>
