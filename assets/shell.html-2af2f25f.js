import{_ as s,X as n,Y as d,Z as l,$ as e,a0 as a,a1 as c,E as o}from"./framework-7f72c1b4.js";const r={},u={href:"https://missing.csail.mit.edu/2020/",target:"_blank",rel:"noopener noreferrer"},v=c(`<h2 id="初始-shell" tabindex="-1"><a class="header-anchor" href="#初始-shell" aria-hidden="true">#</a> 初始 shell</h2><p>当我们打开终端的时候，会看到如下模样的终端提示符</p><div class="language-console line-numbers-mode" data-ext="console"><pre class="language-console"><code>missing:~$ 
